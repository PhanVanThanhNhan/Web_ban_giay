...
<body class="overlay-scrollbar">
			...
			<ul class="navbar-nav nav-right">
				<li class="nav-item avt-wrapper">
					<div class="avt dropdown">
						...
						<ul id="user-menu" class="dropdown-menu" style="margin-top: 14px;">
	...
	<!-- end sidebar -->
	<!-- main content -->
	<div style="position: relative; top: 9em; left: 19em;">
		<h1>Trang chủ quản lý website bán giày</h1>
		<h2><-----sidebar</h2>
	</div>
	<!----------------- MODAL ĐĂNG NHẬP ----------------->
