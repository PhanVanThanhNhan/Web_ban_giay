...
<body class="overlay-scrollbar">
	...
	<c:if test="${admin!=null }">
		<h2
			...
			loại</h2>
		<form action="editloaiController" id="addloaiController"
			style="position: absolute; top: 13.5em; left: 24em;">
			<div style="margin-bottom: 2em">
				<label>Mã loại:</label> <input type="text" name="maloai" value="${ml }"
					placeholder=""><br>
			</div>
			<div style="margin-bottom: 2em">
				<label>Tên loại:</label> <input type="text" name="tenloai" value="${tl }"
					placeholder=""><br>
			</div>
			<div>
				<input style="margin: 0 4em" type="button" class="btn btn-danger cancel " value="Huỷ" onclick="location.href='adminLoaiController'">
				<input class=" btn btn-success btn-add" type="submit" value="Lưu">
			</div>
		</form>
	</c:if>
