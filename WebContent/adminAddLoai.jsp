...
<body class="overlay-scrollbar">
	...
	<div class="sidebar">
		<ul class="sidebar-nav">
			...
			<li class="sidebar-nav-item"><a href="adminXacNhanDatHangController"
	...
	<c:if test="${admin!=null }">
		<h2
			...
			loại</h2>
		<form action="addloaiController" id="addloaiController"
			style="position: absolute; top: 13.5em; left: 24em;">
			<div style="margin-bottom: 2em">
				<label>Mã loại:</label> <input type="text" name="maloai" value=""
					placeholder=""><br>
			</div>
			<div style="margin-bottom: 2em">
				<label>Tên loại:</label> <input type="text" name="tenloai" value=""
					placeholder=""><br>
			</div>
			<div>
				<input style="margin: 0 4em" type="button" class="btn btn-danger cancel " value="Huỷ" onclick="location.href='adminLoaiController'">
