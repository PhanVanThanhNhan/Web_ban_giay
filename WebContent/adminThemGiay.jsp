...
<body class="overlay-scrollbar">
	...
	<c:if test="${admin!=null }">
		<h2
			style="top: 5em; position: relative; left: 12em; border-bottom: 1px solid #ff0000;">Thêm
			loại</h2>
		<form action="addGiayController" method="post" enctype="multipart/form-data"
			style="position: absolute; top: 13.5em; left: 24em;">
			<div class="form-group">
				<label>Mã giày:</label> <input type="text" name="ma-giay" value=""
					placeholder="" class="form-control">
			</div>
			<div class="form-group">
							<label>Loại giày</label> <input type="text" name="loai-giay" value="" class="form-control">
						</div>
			<div class="form-group">
				<label>Ảnh:</label> <input type="file" name="san-pham" value=""
					placeholder=""><br>
			</div>
			<div class="form-group">
				<label>Tên giày:</label> <input type="text" name="ten-giay" value=""
					placeholder="" class="form-control">
			</div>
			<div class="form-group">
				<label>Số lượng:</label> <input type="text" name="so-luong" value=""
					placeholder="" class="form-control">
			</div>
			<div class="form-group">
				<label>Ngày nhập:</label> <input type="date" name="ngay-nhap"
					value="" placeholder="" class="form-control">
			</div>
			<div class="form-group">
				<label>Giá:</label> <input type="text" name="don-gia" value=""
					placeholder="" class="form-control">
			</div>
			<div>
				<input style="margin: 0 4em" type="button" class="btn btn-danger cancel " value="Huỷ" onclick="location.href='adminGiayController'">
				<input class=" btn btn-success btn-add" type="submit" value="Thêm">
			</div>
		</form>
	</c:if>
