...
<body class="overlay-scrollbar">
	...
	<c:if test="${admin!=null }">
		<h2
			...
			sách loại</h2>
		<a class="btn btn-success add_btn" href="adminAddLoai.jsp"><i
			class="fa-solid fa-plus"></i>Thêm</a>
		<table class="tb_gh"
			style="width: 60%; left: 18em; top: 11em; position: relative; text-align: center; border: 0.5px solid #909eff; background: #bfbfbf;">
			<thead>
				<tr>
					<th style="width: 30%">Mã loại</th>
					<th style="width: 40%">Tên Loại</th>
					<th style="width: 15%; align-items: center">Thao tác</th>
				</tr>
			</thead>
			<tbody>
				<c:forEach items="${dsloai }" var="d">
					<tr>
						<td data-th="Mã loại">${d.getMaloai()}</td>
						<td data-th="Tên Loại">${d.getTenloai()}</td>
						<td data-th="Thao tác"><a class="thaotac "
							style="text-decoration: none; margin-right: 2em"
							href="loadloaiController?maloai=${d.getMaloai() }"><i
								class="fa-solid fa-pen"></i> </a> <a class="thaotac"
							style="text-decoration: none"
							href="DeleteLoaiController?hd=remove&ml=${d.getMaloai()}" onclick="confirmDel()"> <i
