...
<body class="overlay-scrollbar">
	...
	<c:if test="${admin!=null }">
		<h2
			style="top: 5em; position: relative; left: 12em; border-bottom: 1px solid #ff0000;">Danh
			sách giày</h2>
		<a class="btn btn-success add_btn" href="adminThemGiay.jsp"><i
			class="fa-solid fa-plus"></i>Thêm</a>
		<table class="tb_gh"
			style="width: 80%; left: 18em; top: 11em; position: relative; text-align: center; border: 0.5px solid #909eff; background: #bfbfbf;">
			<thead>
				<tr>
					<th style="width: 10%">Mã giày</th>
					<th style="width: 12%">Sản phẩm</th>
					<th style="width: 20%">Tên giày</th>
					<th style="width: 12%">Giá</th>
					<th style="width: 10%">Số lượng</th>
					<th style="width: 10%; align-items: center">Thao tác</th>
				</tr>
			</thead>
			<tbody>
				<c:forEach items="${dsgiay }" var="d">
					<tr>
						<td data-th="Mã giày">${d.getMagiay()}</td>
						<td data-th="Sản phẩm"><img style="max-width:234px; max-height: 264px" src="${d.getAnh() }"></td>
						<td data-th="Tên giày">${d.getTengiay()}</td>
						...
						<td data-th="Thao tác"><a class="thaotac "
							style="text-decoration: none; margin-right: 2em"
							href="loadgiayController?mg=${d.getMagiay() }"><i
								class="fa-solid fa-pen"></i> </a> <a class="thaotac"
							style="text-decoration: none"
							href="DeleteGiayController?hd=remove&mg=${d.getMagiay()}"
							onclick="confirmDel()"> <i class="fa-solid fa-trash"></i>
						</a></td>
					</tr>
				</c:forEach>
	...
	<script>
	function confirmDel(){
		alert("Hành động này không thể khôi phục, Chắc chắn xoá!");
	}
